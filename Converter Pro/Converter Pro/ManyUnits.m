...
- (NSArray*) unitValues {
    return [NSArray arrayWithObjects:
            @"1", @"1000", @"0.001", @"453.592", @"28.3495", @"635.29", nil];
}
@end
...
- (NSArray*) unitKeys {
    return [NSArray arrayWithObjects:
            @"Liters", @"Milliliters", @"Gallons", @"Quarts", @"Pints", @"Cups", @"Ounces", @"Tablespoons", @"Teaspoons", @"Cubit Meter", @"Cubit Feet", @"Cubit Inches", @"Barrels (oil)",  nil];
}
